...
export type UUID<
    T extends NullableNumberish = undefined,
    O extends NullableNumberish = undefined
> = `uid-${number}-${number}-${O extends undefined ? (T extends undefined ? typeof DEFAULT : T) : O}`;
